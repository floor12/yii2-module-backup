...
class BackupRestore
{
    ...
    private function restoreDatabase()
    {
        ...
        $this->_connection->createCommand("DROP DATABASE `floor12`")->execute();
        $this->_connection->createCommand("CREATE DATABASE `floor12`")->execute();
        $this->_connection->createCommand("USE `floor12`")->execute();
